...
test('validate input where input is of arbitary length typical of a sentence length', () => {
    const input = 'The boy made his way along the narrow, rickety bridge. Reaching the other side of the town was sometimes difficult, especially in a high wind.';
    const result = validateInput(input)
    expect(result).toBe(true)
})
